...
int main()
{
    ...
    double result1=sub(add(Exponent(exp),Power(x,3)),2);//compute result1
    double result2=add(mul(x,3),mul(Power(x,2),2));//compute result2
    double result3=sub(div(mul(Power(x,3),4),5),mul(x,2));//compute result3
